...
(0, vitest_1.describe)('FeeBumpTool', () => {
    ...
    // ── Input validation ────────────────────────────────────────────────────────
    (0, vitest_1.it)('rejects malformed (non-base64) XDR with ValidationError', async () => {
        ...
        (0, vitest_1.expect)(error.message).toMatch(/Invalid base64 encoding|Invalid inner transaction XDR/);
    });
    (0, vitest_1.it)('rejects corrupted base64 XDR with ValidationError before SDK call', async () => {
