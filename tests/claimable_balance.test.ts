...
const BALANCE_ID =
  "000000009fa02f00b6b9a777edc785963a830424c7b1a3b3646255e6c7899652ab7b6065";
...
describe("ClaimableBalanceTool", () => {
  ...
  beforeEach(() => {
    ...
    vi.mocked(rpcClient.submitTransaction).mockResolvedValue({ hash: "cb_hash", ledger: 10 } as any);
  });
  ...
  it("creates USDC claimable balance with time predicate", async () => {
    ...
    await tool.execute({
      ...
      assetIssuer: ISSUER,
      amount: "5",
      claimants: [{ destination: claimant, predicate: { type: "beforeAbsoluteTime", timestamp: 9999999999 } }],
    });
